     ...
     */
     public function boot()
     {
         ...
         $this->publishes([
             ...
             __DIR__.'/views/authorization/' => resource_path('views/vendor/larapanel/authorization'),
             __DIR__.'/views/components/' => resource_path('views/vendor/larapanel/components'),
             __DIR__.'/views/panel/' => resource_path('views/vendor/larapanel/panel'),
             __DIR__.'/views/users/' => resource_path('views/vendor/larapanel/users'),
